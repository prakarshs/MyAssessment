...
export function Cta() {
  return (
    <div className="w-full rounded-[16px] bg-gradient-to-tr from-pink-700 via-red-500 to-yellow-300 py-[56px] px-[32px] text-center lg:my-[60px] lg:px-[324px] lg:py-[89px]">
